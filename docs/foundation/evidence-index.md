...
- [v0.23.6 critical executor-stability release](2026-09-25-v0.23.6-release-execution.md) — owns the versioned release candidate, exact-commit CI, tag, publication, five-platform archive/checksum verification and continuous ACP Registry update. Publication receipts remain pending until the version commit passes all four push workflows.
