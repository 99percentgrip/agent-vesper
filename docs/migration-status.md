...
| VRO-14 web oracle extraction | LOCAL ACCEPTANCE PASSED; RELEASE GATED | Shared TUI/ACP service executes contained pipe-CDP browser sessions, one-step render escalation, sitemap discovery, and bounded fetch/crawl. Real immutable-image acceptance, MSRV and canonical local gates passed. Exact-commit CI and public driver publication remain release gates. `docs/foundation/vro14-gap-audit.md` records requirements/evidence; `docs/web-tools.md` owns deployment. |
