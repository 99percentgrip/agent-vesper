...
version: 4.0.0
author: 0xbyt4, Agent Vesper library
license: MIT
dependencies: []
...
```bash
python -m pyfiglet "VESPER" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=VESPER&font=Slant" | boxes -d stone
```
...
Search curated ASCII art from the web. Use `bash` with `curl`.
