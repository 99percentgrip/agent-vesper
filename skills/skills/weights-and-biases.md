...
- `~/.agent-vesper/memory/skills/weights-and-biases/references/sweeps.md` - Comprehensive hyperparameter optimization guide
- `~/.agent-vesper/memory/skills/weights-and-biases/references/artifacts.md` - Data and model versioning patterns
- `~/.agent-vesper/memory/skills/weights-and-biases/references/integrations.md` - Framework-specific examples



> Bundled resources for this skill (~/.agent-vesper/memory/skills/weights-and-biases/references/scripts/templates) live in `~/.agent-vesper/memory/skills/weights-and-biases/` next to this file.
