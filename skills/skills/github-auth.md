...
- Give it a name like "agent-vesper"
- Select scopes:
...
- Give it a title like "agent-vesper-<machine-name>"
...
uv run python "$HOME/.agent-vesper/memory/skills/github-auth/scripts/git-credential-token.py"
```
...
if command -v gh &>/dev/null && gh auth status &>/dev/null; then
  ...
  export GITHUB_TOKEN=$(uv run python "$HOME/.agent-vesper/memory/skills/github-auth/scripts/git-credential-token.py")
  echo "AUTH_METHOD=curl"
else
...
> Bundled resources for this skill (~/.agent-vesper/memory/skills/github-auth/references/scripts/templates) live in `~/.agent-vesper/memory/skills/github-auth/` next to this file.
