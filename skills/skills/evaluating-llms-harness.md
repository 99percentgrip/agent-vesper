...
**Benchmark descriptions**: See [~/.agent-vesper/memory/skills/evaluating-llms-harness/references/benchmark-guide.md](~/.agent-vesper/memory/skills/evaluating-llms-harness/references/benchmark-guide.md) for detailed description of all 60+ tasks, what they measure, and interpretation.

**Custom tasks**: See [~/.agent-vesper/memory/skills/evaluating-llms-harness/references/custom-tasks.md](~/.agent-vesper/memory/skills/evaluating-llms-harness/references/custom-tasks.md) for creating domain-specific evaluation tasks.

**API evaluation**: See [~/.agent-vesper/memory/skills/evaluating-llms-harness/references/api-evaluation.md](~/.agent-vesper/memory/skills/evaluating-llms-harness/references/api-evaluation.md) for evaluating OpenAI, Anthropic, and other API models.

**Multi-GPU strategies**: See [~/.agent-vesper/memory/skills/evaluating-llms-harness/references/distributed-eval.md](~/.agent-vesper/memory/skills/evaluating-llms-harness/references/distributed-eval.md) for data parallel and tensor parallel evaluation.
...
> Bundled resources for this skill (~/.agent-vesper/memory/skills/evaluating-llms-harness/references/scripts/templates) live in `~/.agent-vesper/memory/skills/evaluating-llms-harness/` next to this file.
