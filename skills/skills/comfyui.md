...
tags: [comfyui, diffusion, image-generation, video, audio, workflows]
...
prerequisites:
  commands: ["python"]
setup:
  help: "Run ~/.agent-vesper/memory/skills/comfyui/scripts/hardware_check.py FIRST to decide local vs Comfy Cloud; then ~/.agent-vesper/memory/skills/comfyui/scripts/comfyui_setup.sh auto-installs locally (or use Cloud API key for platform.comfy.org)."
---
...
`~/.agent-vesper/memory/skills/comfyui/workflows/README.md`.
...
python ~/.agent-vesper/memory/skills/comfyui/scripts/hardware_check.py
```
...
```bash
python ~/.agent-vesper/memory/skills/comfyui/scripts/health_check.py
...
```bash
python ~/.agent-vesper/memory/skills/comfyui/scripts/extract_schema.py workflow_api.json --summary-only
# → {"parameter_count": 12, "has_negative_prompt": true, "has_seed": true, ...}

python ~/.agent-vesper/memory/skills/comfyui/scripts/extract_schema.py workflow_api.json
...
python ~/.agent-vesper/memory/skills/comfyui/scripts/run_workflow.py \
...
python ~/.agent-vesper/memory/skills/comfyui/scripts/run_batch.py \
  --workflow sdxl.json \
...
| "install ComfyUI" | comfy-cli | `bash ~/.agent-vesper/memory/skills/comfyui/scripts/comfyui_setup.sh` |
...
```bash
python ~/.agent-vesper/memory/skills/comfyui/scripts/hardware_check.py --json
# Optional: also probe `torch` for actual CUDA/MPS:
python ~/.agent-vesper/memory/skills/comfyui/scripts/hardware_check.py --json --check-pytorch
```
...
```bash
bash ~/.agent-vesper/memory/skills/comfyui/scripts/comfyui_setup.sh
# Or with overrides:
bash ~/.agent-vesper/memory/skills/comfyui/scripts/comfyui_setup.sh --m-series --port=8190 --workspace=/data/comfy
```
...
4. Run workflows:
   ```bash
   python ~/.agent-vesper/memory/skills/comfyui/scripts/run_workflow.py \
     --workflow ~/.agent-vesper/memory/skills/comfyui/workflows/flux_dev_txt2img.json \
     --args '{"prompt": "..."}' \
     --host https://cloud.comfy.org \
     --output-dir ./outputs
   ```
...
python ~/.agent-vesper/memory/skills/comfyui/scripts/check_deps.py my_workflow.json
# → are this workflow's nodes/models/embeddings installed?

python ~/.agent-vesper/memory/skills/comfyui/scripts/run_workflow.py \
  --workflow ~/.agent-vesper/memory/skills/comfyui/workflows/sd15_txt2img.json \
...
```bash
python ~/.agent-vesper/memory/skills/comfyui/scripts/run_workflow.py \
  --workflow ~/.agent-vesper/memory/skills/comfyui/workflows/sdxl_img2img.json \
  --input-image image=./photo.png \
...
```bash
python ~/.agent-vesper/memory/skills/comfyui/scripts/run_workflow.py \
  --workflow ~/.agent-vesper/memory/skills/comfyui/workflows/sdxl_inpaint.json \
  --input-image image=./photo.png \
...
python ~/.agent-vesper/memory/skills/comfyui/scripts/fetch_logs.py --tail-queue --host https://cloud.comfy.org
```
...
Use `python ~/.agent-vesper/memory/skills/comfyui/scripts/health_check.py` to run the whole list at once. Manual:
...
> Bundled resources for this skill (~/.agent-vesper/memory/skills/comfyui/references/scripts/templates) live in `~/.agent-vesper/memory/skills/comfyui/` next to this file.
