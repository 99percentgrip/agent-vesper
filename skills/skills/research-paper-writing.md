...
**Load the `arxiv` skill** for structured paper discovery: `read_skill(name="arxiv")`. It provides arXiv REST API search, Semantic Scholar citation graphs, author profiles, and BibTeX generation.

Use `web_search` for broad discovery, `web_reader` for fetching specific papers:
...
# Via web_reader (for specific papers):
web_reader("https://arxiv.org/abs/2303.17651")
```
...
See [~/.agent-vesper/memory/skills/research-paper-writing/references/citation-workflow.md](~/.agent-vesper/memory/skills/research-paper-writing/references/citation-workflow.md) for complete API documentation and the full `CitationManager` class.
...
See [~/.agent-vesper/memory/skills/research-paper-writing/references/experiment-patterns.md](~/.agent-vesper/memory/skills/research-paper-writing/references/experiment-patterns.md) for complete design patterns, cron monitoring, and error recovery.
...
See [~/.agent-vesper/memory/skills/research-paper-writing/references/human-evaluation.md](~/.agent-vesper/memory/skills/research-paper-writing/references/human-evaluation.md) for complete guide including statistical tests for human eval data, crowdsourcing quality control patterns, and IRB guidance.
...
See [~/.agent-vesper/memory/skills/research-paper-writing/references/experiment-patterns.md](~/.agent-vesper/memory/skills/research-paper-writing/references/experiment-patterns.md) for complete implementations of McNemar's test, bootstrapped CIs, and Cohen's h.
...
`~/.agent-vesper/memory/skills/research-paper-writing/references/phase5-paper-drafting.md` — load it with `read_file` when you reach this phase.
Pair it with `~/.agent-vesper/memory/skills/research-paper-writing/references/writing-guide.md` for prose-level style rules.
...
**Few-shot calibration**: If available, include 1-2 real published reviews from the target venue as examples. This dramatically improves score calibration. See [~/.agent-vesper/memory/skills/research-paper-writing/references/reviewer-guidelines.md](~/.agent-vesper/memory/skills/research-paper-writing/references/reviewer-guidelines.md) for example reviews.
...
See [~/.agent-vesper/memory/skills/research-paper-writing/references/checklists.md](~/.agent-vesper/memory/skills/research-paper-writing/references/checklists.md) for:
...
cp -r ~/.agent-vesper/memory/skills/research-paper-writing/templates/icml2026/ new_submission/
...
## Reproduction
To reproduce Table 1: `bash ~/.agent-vesper/memory/skills/research-paper-writing/scripts/reproduce_table1.sh`
To reproduce Figure 2: `python ~/.agent-vesper/memory/skills/research-paper-writing/scripts/make_figure2.py`
...
The main pipeline above targets empirical ML papers. Other paper types require different structures and evidence standards. See [~/.agent-vesper/memory/skills/research-paper-writing/references/paper-types.md](~/.agent-vesper/memory/skills/research-paper-writing/references/paper-types.md) for detailed guidance on each type.
...
This skill is designed for the host agent. It uses the agent's hosted tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other library skills for specific phases:

| Skill | When to Use | How to Load |
|-------|-------------|-------------|
| **arxiv** | Phase 1 (Literature Review): searching arXiv, generating BibTeX, finding related papers via Semantic Scholar | `read_skill(name="arxiv")` |
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.agent-vesper/plans/` | `read_skill(name="plan")` |
| **excalidraw** | Phase 4-5: hand-drawn-style figures and architecture diagrams | `read_skill(name="excalidraw")` |
| **arxiv** | Phase 1 (Literature Review): searching arXiv, BibTeX, related papers | `read_skill(name="arxiv")` |
...
| **`read_file`** / **`write_file`** / **`apply_patch_set`** | Paper editing, experiment scripts, result files. Use `apply_patch_set` for targeted edits to large .tex files. |
| **`web_search`** | Literature discovery: `web_search("transformer attention mechanism 2024")` |
| **`web_reader`** | Fetch paper content, verify citations: `web_reader("https://arxiv.org/abs/2303.17651")` |
...
| **`cronjob` delivery** | Notify the user when experiments complete or drafts are ready: schedule the check as a `cronjob` whose prompt reports results in the session. |
...
delegate_task("Draft the Related Work section. Use web_search and web_reader to 
...
See [~/.agent-vesper/memory/skills/research-paper-writing/references/reviewer-guidelines.md](~/.agent-vesper/memory/skills/research-paper-writing/references/reviewer-guidelines.md) for detailed guidelines, common concerns, and rebuttal strategies.
...
| Human eval criticized as weak | See Step 2.5 and [~/.agent-vesper/memory/skills/research-paper-writing/references/human-evaluation.md](~/.agent-vesper/memory/skills/research-paper-writing/references/human-evaluation.md). Report agreement metrics, annotator details, compensation. |
| Reviewers question reproducibility | Release code (Step 7.9), document all hyperparameters, include seeds and compute details. |
| Theory paper lacks intuition | Add proof sketches with plain-language explanations before formal proofs. See [~/.agent-vesper/memory/skills/research-paper-writing/references/paper-types.md](~/.agent-vesper/memory/skills/research-paper-writing/references/paper-types.md). |
...
| Document | Contents |
|----------|----------|
| [~/.agent-vesper/memory/skills/research-paper-writing/references/writing-guide.md](~/.agent-vesper/memory/skills/research-paper-writing/references/writing-guide.md) | Gopen & Swan 7 principles, Perez micro-tips, Lipton word choice, Steinhardt precision, figure design |
| [~/.agent-vesper/memory/skills/research-paper-writing/references/citation-workflow.md](~/.agent-vesper/memory/skills/research-paper-writing/references/citation-workflow.md) | Citation APIs, Python code, CitationManager class, BibTeX management |
| [~/.agent-vesper/memory/skills/research-paper-writing/references/checklists.md](~/.agent-vesper/memory/skills/research-paper-writing/references/checklists.md) | NeurIPS 16-item, ICML, ICLR, ACL requirements, universal pre-submission checklist |
| [~/.agent-vesper/memory/skills/research-paper-writing/references/reviewer-guidelines.md](~/.agent-vesper/memory/skills/research-paper-writing/references/reviewer-guidelines.md) | Evaluation criteria, scoring, common concerns, rebuttal template |
| [~/.agent-vesper/memory/skills/research-paper-writing/references/sources.md](~/.agent-vesper/memory/skills/research-paper-writing/references/sources.md) | Complete bibliography of all writing guides, conference guidelines, APIs |
| [~/.agent-vesper/memory/skills/research-paper-writing/references/experiment-patterns.md](~/.agent-vesper/memory/skills/research-paper-writing/references/experiment-patterns.md) | Experiment design patterns, evaluation protocols, monitoring, error recovery |
| [~/.agent-vesper/memory/skills/research-paper-writing/references/autoreason-methodology.md](~/.agent-vesper/memory/skills/research-paper-writing/references/autoreason-methodology.md) | Autoreason loop, strategy selection, model guide, prompts, scope constraints, Borda scoring |
| [~/.agent-vesper/memory/skills/research-paper-writing/references/human-evaluation.md](~/.agent-vesper/memory/skills/research-paper-writing/references/human-evaluation.md) | Human evaluation design, annotation guidelines, agreement metrics, crowdsourcing QC, IRB guidance |
| [~/.agent-vesper/memory/skills/research-paper-writing/references/paper-types.md](~/.agent-vesper/memory/skills/research-paper-writing/references/paper-types.md) | Theory papers (proof writing, theorem structure), survey papers, benchmark papers, position papers |

### LaTeX Templates

Templates in `templates/` for: **NeurIPS 2025**, **ICML 2026**, **ICLR 2026**, **ACL**, **AAAI 2026**, **COLM 2025**.

See [~/.agent-vesper/memory/skills/research-paper-writing/templates/README.md](~/.agent-vesper/memory/skills/research-paper-writing/templates/README.md) for compilation instructions.
...
> Bundled resources for this skill (~/.agent-vesper/memory/skills/research-paper-writing/references/scripts/templates) live in `~/.agent-vesper/memory/skills/research-paper-writing/` next to this file.
