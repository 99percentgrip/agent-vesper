...
version: 1.0.0
author: Agent Vesper library + Teknium (design systems sourced from VoltAgent/awesome-design-md)
license: MIT
...
2. Load it: `read_skill(name=name="popular-web-designs", file_path="templates/<site>.md")`
...
> Bundled resources for this skill (~/.agent-vesper/memory/skills/popular-web-designs/references/scripts/templates) live in `~/.agent-vesper/memory/skills/popular-web-designs/` next to this file.
