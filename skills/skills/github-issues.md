...
> Bundled resources for this skill (~/.agent-vesper/memory/skills/github-issues/references/scripts/templates) live in `~/.agent-vesper/memory/skills/github-issues/` next to this file.
