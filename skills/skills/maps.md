...
Script path: `~/.agent-vesper/skills/maps/scripts/maps_client.py`

## Commands

```bash
MAPS=~/.agent-vesper/skills/maps/scripts/maps_client.py
```
...
```bash
python ~/.agent-vesper/skills/maps/scripts/maps_client.py search "Statue of Liberty"
# Should return lat ~40.689, lon ~-74.044

python ~/.agent-vesper/skills/maps/scripts/maps_client.py nearby --near "Times Square" --category restaurant --limit 3
# Should return a list of restaurants within ~500m of Times Square
```

> Bundled resources for this skill (~/.agent-vesper/memory/skills/maps/references/scripts/templates) live in `~/.agent-vesper/memory/skills/maps/` next to this file.
