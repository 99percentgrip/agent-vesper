...
exit non-zero on failure. Run them with `bash`:

```bash
python ~/.agent-vesper/memory/skills/powerpoint/scripts/pptx_create.py deck.json out.pptx
python ~/.agent-vesper/memory/skills/powerpoint/scripts/pptx_read.py deck.pptx --outline      # full JSON outline
python ~/.agent-vesper/memory/skills/powerpoint/scripts/pptx_read.py deck.pptx --notes        # speaker notes
python ~/.agent-vesper/memory/skills/powerpoint/scripts/pptx_read.py deck.pptx --images ./img # export pictures
python ~/.agent-vesper/memory/skills/powerpoint/scripts/pptx_edit.py deck.pptx --replace-text "Old Corp" "New Corp"
python ~/.agent-vesper/memory/skills/powerpoint/scripts/pptx_edit.py deck.pptx --chart-data update.json
python ~/.agent-vesper/memory/skills/powerpoint/scripts/pptx_edit.py deck.pptx --duplicate-slide 2
python ~/.agent-vesper/memory/skills/powerpoint/scripts/pptx_edit.py deck.pptx --remove-slide 3 --move-slide 2 0
python ~/.agent-vesper/memory/skills/powerpoint/scripts/pptx_from_template.py brand.pptx out.pptx --values vals.json
python ~/.agent-vesper/memory/skills/powerpoint/scripts/pptx_render.py deck.pptx --outdir ./render  # slide PNGs
```
...
> Bundled resources for this skill (~/.agent-vesper/memory/skills/powerpoint/references/scripts/templates) live in `~/.agent-vesper/memory/skills/powerpoint/` next to this file.
