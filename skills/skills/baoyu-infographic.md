...
Adapted from [baoyu-infographic](https://github.com/JimLiu/baoyu-skills) for the agent's tool ecosystem.
...
Full definitions: `~/.agent-vesper/memory/skills/baoyu-infographic/references/layouts/<layout>.md`
...
Full definitions: `~/.agent-vesper/memory/skills/baoyu-infographic/references/styles/<style>.md`
...
**Load references**: Read `~/.agent-vesper/memory/skills/baoyu-infographic/references/analysis-framework.md` from this skill.
...
See `~/.agent-vesper/memory/skills/baoyu-infographic/references/analysis-framework.md` for detailed format.
...
See `~/.agent-vesper/memory/skills/baoyu-infographic/references/structured-content-template.md` for detailed format.
...
**Load references**: Read the selected layout from `~/.agent-vesper/memory/skills/baoyu-infographic/references/layouts/<layout>.md` and style from `~/.agent-vesper/memory/skills/baoyu-infographic/references/styles/<style>.md`.

Combine:
1. Layout definition from `~/.agent-vesper/memory/skills/baoyu-infographic/references/layouts/<layout>.md`
2. Style definition from `~/.agent-vesper/memory/skills/baoyu-infographic/references/styles/<style>.md`
3. Base template from `~/.agent-vesper/memory/skills/baoyu-infographic/references/base-prompt.md`
...
- `~/.agent-vesper/memory/skills/baoyu-infographic/references/analysis-framework.md` — Analysis methodology
- `~/.agent-vesper/memory/skills/baoyu-infographic/references/structured-content-template.md` — Content format
- `~/.agent-vesper/memory/skills/baoyu-infographic/references/base-prompt.md` — Prompt template
- `~/.agent-vesper/memory/skills/baoyu-infographic/references/layouts/<layout>.md` — 21 layout definitions
- `~/.agent-vesper/memory/skills/baoyu-infographic/references/styles/<style>.md` — 21 style definitions
...
> Bundled resources for this skill (~/.agent-vesper/memory/skills/baoyu-infographic/references/scripts/templates) live in `~/.agent-vesper/memory/skills/baoyu-infographic/` next to this file.
