...
```bash
python3 ~/.agent-vesper/memory/skills/blocked-page-recovery/scripts/recover_page.py "https://example.com/blocked-article" --json
```
...
> Bundled resources for this skill (~/.agent-vesper/memory/skills/blocked-page-recovery/references/scripts/templates) live in `~/.agent-vesper/memory/skills/blocked-page-recovery/` next to this file.
