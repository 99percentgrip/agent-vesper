...
4. **Optionally upload** for a shareable link using `~/.agent-vesper/memory/skills/excalidraw/scripts/upload.py` via `bash`
...
See `~/.agent-vesper/memory/skills/excalidraw/references/colors.md` for full color tables. Quick reference:
...
- For dark mode diagrams, see `~/.agent-vesper/memory/skills/excalidraw/references/dark-mode.md`
- For larger examples, see `~/.agent-vesper/memory/skills/excalidraw/references/examples.md`



> Bundled resources for this skill (~/.agent-vesper/memory/skills/excalidraw/references/scripts/templates) live in `~/.agent-vesper/memory/skills/excalidraw/` next to this file.
