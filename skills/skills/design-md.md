...
> Bundled resources for this skill (~/.agent-vesper/memory/skills/design-md/references/scripts/templates) live in `~/.agent-vesper/memory/skills/design-md/` next to this file.
