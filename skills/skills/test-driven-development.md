...
pytest ~/.agent-vesper/memory/skills/test-driven-development/tests/test_feature.py::test_specific_behavior -v
```
...
```python
# RED — verify failure
terminal("pytest ~/.agent-vesper/memory/skills/test-driven-development/tests/test_feature.py::test_name -v")
