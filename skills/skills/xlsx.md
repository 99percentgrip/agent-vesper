...
Run the helper scripts with the `bash` tool from this skill's
`scripts/` directory (every script supports `--help`):

```bash
python ~/.agent-vesper/memory/skills/xlsx/scripts/xlsx_create.py spec.json report.xlsx   # build from JSON spec
python ~/.agent-vesper/memory/skills/xlsx/scripts/xlsx_read.py report.xlsx --sheets      # inventory
python ~/.agent-vesper/memory/skills/xlsx/scripts/xlsx_read.py report.xlsx --json --sheet Data
python ~/.agent-vesper/memory/skills/xlsx/scripts/xlsx_read.py report.xlsx --formulas
python ~/.agent-vesper/memory/skills/xlsx/scripts/xlsx_edit.py report.xlsx --sheet Data --set B2=42 --recalc
python ~/.agent-vesper/memory/skills/xlsx/scripts/xlsx_restructure.py report.xlsx --sheet Data --insert-rows 3:2
python ~/.agent-vesper/memory/skills/xlsx/scripts/xlsx_recalc.py report.xlsx
python ~/.agent-vesper/memory/skills/xlsx/scripts/csv_to_xlsx.py data.csv out.xlsx --encoding utf-8
python ~/.agent-vesper/memory/skills/xlsx/scripts/xlsx_to_csv.py report.xlsx out.csv --sheet Data
```
...
5. **Restructure**: for insert/delete on sheets that have formulas,
   ...
   limits: `~/.agent-vesper/memory/skills/xlsx/references/restructuring.md`.
...
- **`xlsx_edit.py` insert/delete does not shift references** (raw
  ...
  `~/.agent-vesper/memory/skills/xlsx/references/restructuring.md`.
...
> Bundled resources for this skill (~/.agent-vesper/memory/skills/xlsx/references/scripts/templates) live in `~/.agent-vesper/memory/skills/xlsx/` next to this file.
