...
Use `uv` so the dependency is installed into the same agent-managed environment
...
> Bundled resources for this skill (~/.agent-vesper/memory/skills/youtube-content/references/scripts/templates) live in `~/.agent-vesper/memory/skills/youtube-content/` next to this file.
