...
| Read abstract (web) | `web_reader(urls=["https://arxiv.org/abs/2402.03300"])` |
| Read full paper (PDF) | `web_reader(urls=["https://arxiv.org/pdf/2402.03300"])` |
...
The `~/.agent-vesper/memory/skills/arxiv/scripts/search_arxiv.py` script handles XML parsing and provides clean output:

```bash
python ~/.agent-vesper/memory/skills/arxiv/scripts/search_arxiv.py "GRPO reinforcement learning"
python ~/.agent-vesper/memory/skills/arxiv/scripts/search_arxiv.py "transformer attention" --max 10 --sort date
python ~/.agent-vesper/memory/skills/arxiv/scripts/search_arxiv.py --author "Yann LeCun" --max 5
python ~/.agent-vesper/memory/skills/arxiv/scripts/search_arxiv.py --category cs.AI --sort date
python ~/.agent-vesper/memory/skills/arxiv/scripts/search_arxiv.py --id 2402.03300
python ~/.agent-vesper/memory/skills/arxiv/scripts/search_arxiv.py --id 2402.03300,2401.12345
```
...
1. **Discover**: `python ~/.agent-vesper/memory/skills/arxiv/scripts/search_arxiv.py "your topic" --sort date --max 10`
2. **Assess impact**: `curl -s "https://api.semanticscholar.org/graph/v1/paper/arXiv:ID?fields=citationCount,influentialCitationCount"`
3. **Read abstract**: `web_reader(urls=["https://arxiv.org/abs/ID"])`
4. **Read full paper**: `web_reader(urls=["https://arxiv.org/pdf/ID"])`
...
> Bundled resources for this skill (~/.agent-vesper/memory/skills/arxiv/references/scripts/templates) live in `~/.agent-vesper/memory/skills/arxiv/` next to this file.
