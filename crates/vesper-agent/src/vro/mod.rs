...
impl VroOrchestrator {
    ...
    pub async fn execute_react(
        ...
        // review — matching the explicit-invocation pattern (explicit CLI
        // invocation, no magic interception). ADR 0020 removed the dormant
        // orchestrator final-output seam; only the TUI tools own review.
